...
async def apply(job_id: str, resume_id: str, user=Depends(require_role("org:member"))):
...
async def get_application(application_id: str, user=Depends(require_role("org:admin"))):
